...
No jogo acima (uma versão expandida do dilema dos prisioneiros), a ação Q (cooperar) para o jogador 2 é *racional*? E *racionalizável*?
...
A *racionabilidade* só mantém no jogo estratégias que para alguma crença *compatível com conhecimento comum de racionalidade* que um jogador tenha, essa estratégia seria uma melhor-resposta para aquela crença

Como vimos pela **Afirmação 2**, um jogador racional jamais escolherá uma *estratégia estritamente dominada* &mdash; podemos então fazer o processo espelhado da racionabilidade, e a cada iteraçao eliminar tais estratégias que nenhum jogador racional jamais faria 
