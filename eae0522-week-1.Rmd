...
```{r, echo=FALSE, out.width = '40%', fig.align='center'}
knitr::include_graphics("figs/week1-fig19.png")
```
...
Encontramos a estratégia maxmin achando a estratégia que dá o mesmo *payoff* para *si mesmo* não importa o que os outros jogarem &mdash; essa é a noção de "garantir" um payoff, que chamamos de **nível de segurança**
