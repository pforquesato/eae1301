...
Essa é a representação em forma extensiva do jogo &mdash; quantas estratégias puras o nosso pobre motorista tem? Qual é a melhor? E quando ele alcançar uma saída, ele quererá continuar com a sua estratégia ou mudar de ideia?
...
Podemos aplicar o **equilíbrio perfeito em subjogos** nos exemplos vistos até aqui &mdash; na batalha dos sexos voluntária a indução para trás não funciona (pois é de *informação imperfeita*): quais são então os equilíbrios de Nash e perfeitos em subjogos? E se aplicarmos o princípio de *indução para frente*, algum ENPS se torna pouco crível?
...
Um **autômato** é composto de: (i) um conjunto de estados $\mathcal{W}$, (ii) um estado inicial $w_0$, (iii) uma função $f$ que especifica em cada estado o que jogar, e (iv) uma função de transição $\tau$ que muda de estado dependendo da realização
...
Para vários autômatos importantes, como o **grim trigger** ou o **tit-for-tat** (que veremos aqui), há apenas 2-4 estados, então isso simplifica muito!  [[Vejam esse site interativo sobre autômatos no dilema dos prisioneiros repetido]](https://ncase.me/trust/)
